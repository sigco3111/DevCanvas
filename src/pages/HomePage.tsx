...
interface HomePageProps {
  onProjectCardClick: (project: PortfolioItem) => void;
}

/**
 * DevCanvas 홈페이지 컴포넌트
 * 요구사항 2.1: 프로젝트 카드 클릭 시 모달 열기 기능
 */
const HomePage: React.FC<HomePageProps> = ({ onProjectCardClick }) => {
  // 포트폴리오 데이터 상태
          ...
          <section id="projects" aria-labelledby="projects-heading" className="py-16 bg-white dark:bg-gray-800">
            <div className="container mx-auto px-4 py-8">
              ...
              {!isLoading && !error && currentPageProjects.length > 0 && (
                <>
                  <div role="feed" aria-label="프로젝트 목록" className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
